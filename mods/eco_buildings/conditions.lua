building_lib.register_condition("on_solid_underground", {
...
building_lib.register_condition("on_slope", {
    can_build = function(mapblock_pos)
...
building_lib.register_condition("on_biome", {
...
building_lib.register_condition("not_on_biome", {
    can_build = function(mapblock_pos, _, biome_name)
		local biome = eco_mapgen.get_biome(mapblock_pos)
